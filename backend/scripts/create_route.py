...
route_content = r'''import { NextResponse } from "next/server";
...
target_path = r"C:\ischemic\src\app\api\ml\predict\route.ts"
with open(target_path, "w", encoding="utf-8") as f:
    f.write(route_content)

print(f"Successfully wrote {target_path} ({len(route_content)} bytes)")
