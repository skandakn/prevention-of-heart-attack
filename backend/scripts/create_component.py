...
with open(r"C:\ischemic\src\components\ml\ResearchModelSignalCard.tsx", "w", encoding="utf-8") as f:
    f.write(card_content)

print("Created ResearchModelSignalCard.tsx successfully")
